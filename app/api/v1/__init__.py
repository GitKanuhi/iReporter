...
from app.api.v1.views import RedflagsList, SpecificRedflag, EditComment, EditLocation, Delete, User, Users
...
api.add_resource(SpecificRedflag, '/red-flags/<string:incidentId>',strict_slashes=False)
api.add_resource(EditComment, '/red-flags/<string:incidentId>/comment',strict_slashes=False)
api.add_resource(User, '/user',strict_slashes=False)
